...
extension SharedPrefsExtension on SharedPreferences {
  ...
  String? get token => getString(SharedPrefsConstant.tokenKey);

  String? get locale => getString(SharedPrefsConstant.localeKey);

  String? get refreshToken => getString(SharedPrefsConstant.refreshTokenKey);

  String? get expires => getString(SharedPrefsConstant.expiresKey);

  bool get acceptDisclaimer => getBool(SharedPrefsConstant.acceptDisclaimer) ?? false;
}